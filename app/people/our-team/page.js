  ...
  return (
    <div className=" mt-[2rem] ">
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"Board of Directors"} small={true} />
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"Team Head (s)"} small={true} />
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"Tech Team"} small={true} />

        <div
          id="tech-team"
          className=" mt-[2.5rem] flex flex-wrap  gap-[2rem] "
        >
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"YCPR"} small={true} />
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"YCLA"} small={true} />
      ...
      <div className=" mt-[4rem] ">
        <CustomTitle title={"Social Media and Graphics Team"} small={true} />
        <div className=" mt-[2.5rem] flex flex-wrap  gap-[2rem] ">
          {socialMediaGraphicsTeam.map((data, index) => {
            return <TeamCard key={index} data={data} />;
          })}
        </div>
      </div>
      ...
      <div className=" mt-[3rem] flex flex-col gap-[1rem] font-montserrat text-primary ">
        <h2 className=" font-[600] text-[1.6rem] ">
          Interested to join our team ?
        </h2>
        <div>
          <PrimaryButton
            data={{ title: "Apply Now", execute: () => {} }}
            icon={<IoArrowForward />}
          />
        </div>
      </div>
